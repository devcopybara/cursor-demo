---
name: release-notes
description: 두 git 태그/커밋 사이의 변경으로 한국어 릴리스 노트를 작성한다. 사용자
가 "릴리스 노트", "변경 로그", "changelog"를 언급하거나 배포 준비를 할 때 사용한다.
---
...
## 절차
1. `scripts/collect_commits.sh <이전태그> <현재태그>`를 실행해 커밋 목록을 수집한
다.
